...
class Enemy(GameSprite):
   #the method where the sprite is controlled by the arrow keys of the keyboard
    ...
    def update(self):
        ''' moves the character by applying the current horizontal and vertical speed'''
        # horizontal movement first
        left_side = w2.rect.x + 50
        right_side = win_width - 85
...
monster1 = Enemy('enemy.png', win_width-160,150,80,80,5)
monster2 = Enemy('monster_3.png', win_width-80,240,80,80,5)
...
final_sprite = GameSprite('goal.png', win_width-80, win_height-100, 80,80)
#game loop
run = True
finish = False
while run:
